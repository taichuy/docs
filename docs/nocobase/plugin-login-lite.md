...
1.  **开启插件**: 进入 NocoBase 插件管理器，找到`plugin-login-lite` 并启用。
...
如果您需要更高级的功能，例如 **微信生态集成（微信公众号扫码登陆，微信小程序的用户统一认证功能）**，联系我们购买付费插件，交付和收费如下：
| 授权类型 | 价格 | 包含权益 | 适合场景 |
| ----------------------- | ------------- | ------------------------------------------------------------------------------------ | -------------------------------------- |
...
详细查看：[太初 y 的 nocobase 插件](https://docs.taichuy.com/nocobase)
